...
import { LovableGuard } from "@/components/LovableGuard";
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="inline-flex items-center justify-center rounded-full border border-input bg-background px-5 py-2.5 text-sm font-semibold text-foreground hover:bg-accent/10">
            Go home
          </a>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Fresh, premium-quality Indian produce delivered to international markets." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "THE GILL EXIM" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          address: {
            "@type": "PostalAddress",
            streetAddress: "835/3 Kalmeshwar Street, Itagi",
